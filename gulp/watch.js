...
const watch = ({
  ...
  gulp.task('watch', () => {
    if (!args.production) {
      ...
      // Font files
      gulp.watch(`./${dir.source}/${dir.asset}/${dir.font}/{${gulpConfig.fileExpression.font}}`, gulp.series('font'));

      // Image files
      gulp.watch(`./${dir.source}/${dir.asset}/${dir.font}/{${gulpConfig.fileExpression.image}}`, gulp.series('image'));
